...
var PartitionComponent = (function () {
    function PartitionComponent() {
        this.levelChanged = new core_1.EventEmitter();
    }
    PartitionComponent.prototype.ngOnInit = function () {
        this.draw();
    };
    PartitionComponent.prototype.draw = function () {
        var dataRoot = this.data;
        var levelEvent = this.levelChanged;
        var margin = { top: 178, right: 178, bottom: 178, left: 178 }, radius = Math.min(margin.top, margin.right, margin.bottom, margin.left) - 10;
            ...
            function zoomOut(p) {
                ...
                if (p.displayLevel === 'dealership') {
                    levelEvent.emit({
                        ...
                        selection: p.parent.name
                    });
                }
                if (p.displayLevel === 'zone') {
                    levelEvent.emit({
                        displayLevel: 'region',
                        selectionType: null,
                        selection: null
...
], PartitionComponent.prototype, "data", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", core_1.EventEmitter)
], PartitionComponent.prototype, "levelChanged", void 0);
PartitionComponent = __decorate([
    core_1.Component({
        selector: 'partition',
        providers: [],
        styles: ["\n    .bar {\n      fill: red;\n    }\n  "],
        template: '<div class="theGraph"></div>'
    }),
    __metadata("design:paramtypes", [])
], PartitionComponent);
exports.PartitionComponent = PartitionComponent;
//# sourceMappingURL=partition.component.js.map