...
var Competition = (function (_super) {
    ...
    function Competition(options) {
        ...
        _this.marketId = options['marketId'] || 0;
        _this.market = options['market'] || new marketclasses_1.Market();
        _this.baseRewardSchemeId = options['baseRewardSchemeId'] || 0;
        _this.baseRewardScheme = options['baseRewardScheme'] || new BaseRewardScheme();
        _this.termsAndConditionId = options['termsAndConditionId'] || 0;
        _this.termsAndCondition = options['termsAndCondition'] || new TermsAndCondition();
        _this.title = options['title'] || '';
        _this.about = options['about'] || '';
        ...
        _this.makeImageLink = options['makeImageLink'];
        _this.linkTitle = options['linkTitle'] || '';
        _this.linkUrl = options['linkUrl'] || '';
        _this.activeImage = options['activeImage'] || new mediainfoclasses_1.MediaInfo();
        _this.activeImageId = options['activeImageId'] || 0;
        _this.makeActiveImageLink = options['makeActiveImageLink'];
        _this.completedImage = options['completedImage'] || new mediainfoclasses_1.MediaInfo();
        _this.completedImageId = options['completedImageId'] || 0;
        _this.makeCompletedImageLink = options['makeCompletedImageLink'];
