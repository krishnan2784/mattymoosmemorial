...
export class MediaDataService extends RequestHelper implements IMediaDataService {
    ...
    constructor(public http: Http, @Inject(ORIGIN_URL) baseUrl: string, public alertService: AlertService) {
    ...
    getMediaInfo(id): Observable<MediaInfo> {
        return Observable.create(observer => {
          this.http.get(`${this.baseUrl}/Media/GetMediaInfo?id=${id}`).subscribe(
                (result) => {
    ...
    private getAuthToken(): Observable<string> {
        return Observable.create(observer => {
            this.getRequestBase(`${this.baseUrl}/Market/GetAuthToken`).subscribe((result) => {
