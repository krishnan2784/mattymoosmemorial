...
var FeedIndexComponent = /** @class */ (function (_super) {
    ...
    function FeedIndexComponent(route, router, feedDataService, sharedService, overlay, vcRef, confirmBox, permissionService) {
        var _this = _super.call(this, sharedService, permissionService, '', true, '', DefaultTabNavs.feedIndexTabs, '/feed') || this;
        _this.route = route;
        _this.router = router;
    ...
    FeedIndexComponent = __decorate([
        ...
        __metadata("design:paramtypes", [router_1.ActivatedRoute, router_1.Router, Object, Object, Object, core_1.ViewContainerRef, Object, Object])
    ], FeedIndexComponent);
