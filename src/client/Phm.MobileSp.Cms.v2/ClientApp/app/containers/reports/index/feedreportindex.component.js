...
var FeedReportIndexComponent = /** @class */ (function (_super) {
    ...
    FeedReportIndexComponent.prototype.getData = function () {
        ...
        this.feedDataService.getFeeditemsByType(this.feedTypeId).subscribe(function (result) {
            if (!_this.sharedService.currentMarket.isLive && result && result.length > 0) {
    ...
    FeedReportIndexComponent = __decorate([
        ...
        __metadata("design:paramtypes", [router_1.ActivatedRoute,
            router_1.Router,
            feeddataservice_1.FeedDataService, typeof (_a = typeof shareservice_1.ShareService !== "undefined" && shareservice_1.ShareService) === "function" && _a || Object])
